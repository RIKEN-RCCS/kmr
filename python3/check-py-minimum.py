...
XX = [(0, "Matsu"), (1, "Ume"), (2, "Sakura"), (3, "Fuji"),
      (4, "Ayame"), (5, "Botan"), (6, "Hagi"), (7, "Susuki"),
      (8, "Kiku"), (9, "Momiji"), (10, "Yanagi"), (11, "Kiri")]
LL = len(XX)
...
for (k, v) in XX:
    k01.add(float(k), v)
k01.add_kv_done()
sxx = list(map((lambda p: (lambda x, y: (float(x), y))(*p)), XX))
...
sys.stderr.flush()
if (RANK == 0):
    print("CHECK printing exceptions...")
    sys.stdout.flush()
...
sys.stderr.flush()
if (RANK == 0):
    print("CHECK unfreed kvs message...")
    sys.stdout.flush()
